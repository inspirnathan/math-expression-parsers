...
function peg$parse(input, options) {
  ...
  var peg$f3 = function() { return NumericLiteral(text()) };
  var peg$f4 = function(expr) { return UnaryExpression(expr) };
  var peg$f5 = function() { return text(); };
  var peg$f6 = function(id, expr) { return FunctionExpression(id, expr) };
  var peg$currPos = 0;
  var peg$savedPos = 0;
  ...
  function peg$parseFunction() {
    ...
    s1 = peg$parseID();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseParenthesizedExpression();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s0 = peg$f6(s1, s2);
      } else {
